...
export function ProfessionalDetailsForm({ formData, errors, handleChange, fields }: SectionProps) {
  ...
  return (
    <>
      <SectionWrapper title={form?.professional_details?.title ?? t('professionalTitle')} subtitle={form?.professional_details?.subtitle ?? t('professionalSubtitle')}>
